...
youtube_jobs = sqlalchemy.Table(
    ...
    sqlalchemy.Column('email', sqlalchemy.ForeignKey(
        google_accounts.c.email), nullable=False, primary_key=True),
    sqlalchemy.Column(
        'created_at', sqlalchemy.dialects.postgresql.TIMESTAMP, server_default=text('NOW()'))
)
...
youtube_channels = sqlalchemy.Table(
    ...
    sqlalchemy.Column('upload_playist_id', sqlalchemy.String, nullable=False),
    sqlalchemy.Column(
        'created_at', sqlalchemy.dialects.postgresql.TIMESTAMP, server_default=text('NOW()')),
    sqlalchemy.Column(
        'last_updated', sqlalchemy.dialects.postgresql.TIMESTAMP, server_default=text('NOW()'))
)
...
youtube_subscriptions = sqlalchemy.Table(
    ...
    sqlalchemy.Column('channel_id', sqlalchemy.ForeignKey(
        youtube_channels.c.id), nullable=False),
    sqlalchemy.Column('email', sqlalchemy.ForeignKey(
...
youtube_video_category = sqlalchemy.Table(
    ...
    sqlalchemy.Column('video_id', sqlalchemy.ForeignKey(
        youtube_videos.c.id), nullable=False),
    sqlalchemy.Column('category_id', sqlalchemy.ForeignKey(
        youtube_video_categories.c.id), nullable=False)
)
